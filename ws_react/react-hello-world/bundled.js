...
var Counter = React.createClass({displayName: "Counter",
  ...
  render: function(){
    ...
    React.createElement("button", {onClick: this.increaseCount}, "|+|")
    ))
  }
});
...
var CounterList = React.createClass({displayName: "CounterList",
  getInitialState: function(){
    return {
  ...
  renderCounter: function(purpose){
    return React.createElement(Counter, {onCount: this.increaseTotalCount, purpose: purpose})
  },
  render: function(){
    return React.createElement("ul", null, 
      this.state.items.map(this.renderCounter), 
      React.createElement("li", null, "Total is ", this.state.total || "None yet")
    )
  }
});

React.render(React.createElement(CounterList, null), document.getElementById('myApp'));
module.exports = CounterList;

},{"./counter":1,"react":149}],3:[function(require,module,exports){
